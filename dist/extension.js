...
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand('extends.helloWorld', () => {
        // The code you place here will be executed every time your command is executed
        // Display a message box to the user
        vscode.window.showInformationMessage('Hello World from extends!');
    });
    (0, utils_1.listenForEditorChanges)();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.listenForEditorChanges = exports.getActiveEditorContent = void 0;
const vscode = __importStar(__webpack_require__(1));
...
exports.listenForEditorChanges = listenForEditorChanges;
